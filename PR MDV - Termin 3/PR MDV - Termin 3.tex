...
\begin{quote}
    ...
    \begin{quote}
        ...
        \begin{quote}
            In der zweiten Vorbereitungsaufgabe sollte eine Matlab-Funktion geschrieben werden die einen Sinusfunktion Siehe
            Quelltext stromPhasSchnitt.m im Anhang\\
