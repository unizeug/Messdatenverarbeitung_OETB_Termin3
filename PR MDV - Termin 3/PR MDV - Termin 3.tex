...
\begin{quote}
    ...
    \begin{quote}
        ...
        \begin{figure}[H]
        \centering
            \includegraphics[scale=0.7, trim = 0cm 0cm 0cm 0cm, clip]{./Bilder/VerschobenerSinusAufgabe1}
    ...
    \begin{quote}
            ...
            \hspace{-12em}
                \begin{minipage}{0.6\textwidth}
                    ...
                    \begin{figure}[H]
                        \label{fig:}
                        \includegraphics[scale=0.25]{./Bilder/Phasenanschnitt08pi.pdf} %FIXME [width=640px,
                         %height=474px]
            ...
            \hspace{-12em}
                \begin{minipage}{0.6\textwidth}
                    ...
                    \begin{figure}[H]
                        \label{fig:}
                        \includegraphics[scale=0.25]{./Bilder/Phasenanschnitt28pi.pdf} %FIXME [width=640px,
                        % height=474px]
            ...
            \hspace{-12em}
                \begin{minipage}{0.6\textwidth}
                    ...
                    \begin{figure}[H]
                        \label{fig:}
                        \includegraphics[scale=0.25]{./Bilder/Phasenanschnitt48pi.pdf} %FIXME [width=640px,
                        % height=474px]
            ...
            \hspace{-12em}
                \begin{minipage}{0.6\textwidth}
                    ...
                    \begin{figure}[H]
                        \label{fig:}
                        \includegraphics[scale=0.25]{./Bilder/Phasenanschnitt68pi.pdf} %FIXME [width=640px,
                        % height=474px]
            ...
            \hspace{-12em}
                \begin{minipage}{0.6\textwidth}
                    ...
                    \begin{figure}[H]
                        \label{fig:}
                        \includegraphics[scale=0.25]{./Bilder/Phasenanschnitt88pi.pdf} %FIXME [width=640px,
                        % height=474px]
...
\begin{quote}
    ...
    \begin{quote}
        \lstinputlisting[
            ...
            label=lst:Matlab]
            {./Scilab/EffektivwertZeitbereich.m}
    \end{quote}
